...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup() {
    ...
    var reversePayment = !!lodash__WEBPACK_IMPORTED_MODULE_1___default().get(window._setting_, 'payment_sort', false);
    var sku = JSON.parse((route === null || route === void 0 ? void 0 : (_route$query = route.query) === null || _route$query === void 0 ? void 0 : _route$query.sku) || '');
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                (0,vant__WEBPACK_IMPORTED_MODULE_5__.Toast)('请输入收货人信息');
                return _context.abrupt("return");

              case 3:
                vant__WEBPACK_IMPORTED_MODULE_5__.Toast.loading({
                  message: '下单中...',
                  forbidClick: true
                });
                data.loading = true;
              ...
              case 7:
                ...
                data.loading = false;
                vant__WEBPACK_IMPORTED_MODULE_5__.Toast.clear();
                id = result.id;
    ...
    var disableAlipay = (0,vue__WEBPACK_IMPORTED_MODULE_3__.computed)(function () {
      return lodash__WEBPACK_IMPORTED_MODULE_1___default().get(window._setting_, 'disable_alipay', (0,_api_common__WEBPACK_IMPORTED_MODULE_7__.stringToBoolean)("1"));
    });
    var disableWechat = (0,vue__WEBPACK_IMPORTED_MODULE_3__.computed)(function () {
      return lodash__WEBPACK_IMPORTED_MODULE_1___default().get(window._setting_, 'disable_wechat', (0,_api_common__WEBPACK_IMPORTED_MODULE_7__.stringToBoolean)("0"));
    });
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  , ["thumb"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_van_cell, null, {
    ...
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_van_cell_group, {
        "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["flex", $setup.reversePayment && 'reverse'])
      }, {
        "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
