...
Route::group([
    ...
    Route::post('notify/charge', 'OrderController@chargeNotify');
    ...
    Route::any('notify/ZBPay', 'OrderController@orderNotifyZBPay');
    Route::any('notify/common', 'OrderController@commonOrderNotify');
