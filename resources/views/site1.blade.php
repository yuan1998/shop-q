...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/vant@3.2.7/lib/index.min.css" data-asset="{{asset('/css/vant.css')}}" onerror="onCdnError(this)">
...
<script src="https://cdn.jsdelivr.net/npm/vant@3.2.7/lib/vant.min.js" data-asset="{{asset('/js/vant.js')}}"></script>
